          ...
          <div className="flex flex-col md:flex-row bg-teal-50 rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="md:w-1/2">
              <Image
                ...
                src="/welsh.jpeg" // Replace with the actual image path
              />
            </div>
            ...
            <div className="md:w-1/2 p-8 flex flex-col justify-center">
              ...
              <p className="text-gray-600 text-lg mt-4 leading-relaxed">
                The **Welsh Pony** is a **versatile**, **gentle**, and **energetic** breed native to Wales. Known for their compact 
                size, they are incredibly suitable for children, beginners, and even seasoned riders who are looking for a smaller, 
                more agile pony. 
              ...
              <div className="flex items-center mt-6">
                <span className="title-font font-bold text-3xl text-gray-900">$3,000.00</span>
