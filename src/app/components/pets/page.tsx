...
const animals = [
  ...
  { name: "Guinea Pig", icon: <GiRat />, color: "text-purple-500", glow: "shadow-purple-500", emoji: "🐁", link: "/components/pets/guinea" },
  ...
  { name: "Snake", icon: <GiSnake />, color: "text-gray-500", glow: "shadow-gray-500", emoji: "🐍", link: "/components/pets/snakes" },
