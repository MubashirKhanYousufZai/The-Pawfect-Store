...
const BathTubPage = () => {
  return (
    <div className="bg-gradient-to-br from-teal-50 to-blue-100 min-h-screen flex items-center justify-center">
      <section className="w-full max-w-6xl px-6 py-16">
        <div className="flex flex-col md:flex-row bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.08)] overflow-hidden transition-all duration-300">
          ...
          <div className="md:w-1/2 h-80 md:h-auto">
            <Image
              src="/bathtub.jpeg" // ✅ Make sure this image is in your /public folder
              alt="Pet Bath Tub"
              width={600}
              height={600}
          ...
          <div className="md:w-1/2 p-8 md:p-10 flex flex-col justify-center space-y-6">
            ...
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              Keep your pets clean in style with our <strong>ergonomic bath tub</strong>. 
              Made from <span className="text-teal-500 font-medium">non-slip, pet-safe plastic</span>, this tub is perfect for small to medium pets. 
              Lightweight, durable, and easy to clean — it turns every bath into a spa day!
            </p>
