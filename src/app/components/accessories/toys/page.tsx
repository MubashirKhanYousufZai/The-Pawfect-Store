...
const ToysPage = () => {
  return (
    <div className="bg-gradient-to-br from-teal-50 to-orange-100 min-h-screen flex items-center justify-center">
      <section className="w-full max-w-6xl px-6 py-16">
        <div className="flex flex-col md:flex-row bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.1)] overflow-hidden transition-all duration-300">
          ...
          <div className="md:w-1/2 h-80 md:h-auto">
            <Image
              src="/toys.jpeg" // ✅ Place your pet toy image here
              alt="Fun Pet Toys"
              width={600}
              height={600}
          ...
          <div className="md:w-1/2 p-8 md:p-10 flex flex-col justify-center space-y-6">
            ...
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              Keep your pets engaged for hours with our <strong>interactive squeaky toys</strong>. 
              Crafted from <span className="text-teal-500 font-medium">non-toxic rubber</span> and plush fabric, these toys are great 
              for <strong>teething, training</strong>, and <strong>playtime fun</strong> indoors or outdoors.
            </p>
