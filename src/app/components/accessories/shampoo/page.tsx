...
const ShampooPage = () => {
  return (
    <div className="bg-gradient-to-br from-teal-50 to-indigo-100 min-h-screen flex items-center justify-center">
      <section className="w-full max-w-6xl px-6 py-16">
        <div className="flex flex-col md:flex-row bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.08)] overflow-hidden transition-all duration-300">
          ...
          <div className="md:w-1/2 h-80 md:h-auto">
            <Image
              src="/shampoo.jpeg" // ✅ Add this image to /public
              alt="Pet Shampoo Bottle"
              width={600}
              height={600}
          ...
          <div className="md:w-1/2 p-8 md:p-10 flex flex-col justify-center space-y-6">
            ...
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              Make bath time a breeze with our <strong>soothing pet shampoo</strong>. 
              Enriched with <span className="text-teal-500 font-medium">natural oils</span> and <span className="text-teal-500 font-medium">hypoallergenic formula</span>, 
              it keeps your furry friends coat clean, soft, and healthy — no tears, no tangles!
            </p>
