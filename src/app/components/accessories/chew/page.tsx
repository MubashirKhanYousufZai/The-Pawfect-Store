      ...
      <section className="w-full max-w-6xl px-6 py-16">
        <div className="flex flex-col md:flex-row bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.08)] overflow-hidden transition-all duration-300">
          ...
          <div className="md:w-1/2 h-80 md:h-auto">
            <Image
              src="/chew.jpeg" // ✅ Ensure this image is in your public/ folder
              alt="Durable Chew Toys"
              width={600}
              height={600}
          ...
          <div className="md:w-1/2 p-8 md:p-10 flex flex-col justify-center space-y-6">
            ...
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              Keep your dog entertained and their teeth clean with our <strong>long-lasting chew toys</strong>. 
              Made from <span className="text-teal-600 font-medium">non-toxic rubber</span> and 
              designed for <span className="text-teal-600 font-medium">maximum chew resistance</span>, 
              these toys are a perfect solution to prevent boredom and support dental health.
            </p>

            {/* Price + Actions */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-4 space-y-4 sm:space-y-0">
              <span className="text-3xl font-bold text-gray-900">$12.49</span>
