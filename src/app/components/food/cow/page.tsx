...
const CowFoodPage = () => {
  const cowFoods = [
    {
      name: 'Milk-Master Mix',
      role: 'Cow Food',
      image: '/CowF2 (1).webp',  // Ensure you have the appropriate cow food images
      description: 'High-quality feed for cows to produce rich and healthy milk!',
      price: 39.99,
    },
    {
      name: 'Grain-Hay Delight',
      role: 'Cow Food',
      image: '/CowF1.jpeg',
      description: 'A balanced mixture of grain and hay for better health and energy.',
      price: 42.99,
    },
    {
      name: 'Farm Fresh Munch',
      role: 'Cow Food',
      image: '/CowF2 (2).webp',
      description: 'Nutritious, fresh food for cows with a blend of vitamins and minerals!',
      price: 35.49,
    },
    {
      name: 'Cow-Boost Pro Feed',
      role: 'Cow Food',
      image: '/CowF2 (3).webp',
      description: 'Premium quality feed to boost your cows health and milk production.',
      price: 47.99,
    },
  ];

  return (
    <div className="bg-gradient-to-r from-teal-200 to-yellow-700 py-24">
      <section className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-white mb-4 leading-tight tracking-tight">
            NUTRITIOUS FOOD FOR YOUR COWS 🐄
          </h1>
          <p className="text-lg text-white max-w-2xl mx-auto leading-relaxed">
            Give your cows the best nutrition to thrive with our premium feed mixes.  
            Perfectly formulated for healthy cows and improved milk production! 🌾🍶
          </p>
        </div>

        <div className="flex flex-wrap -m-4">
          {cowFoods.map((food, index) => (
