...
const HorseFoodPage = () => {
  const horseFoods = [
    {
      name: 'Equine Energy Mix',
      role: 'Horse Food',
      image: '/HorseF1.jpeg',
      description: 'A high-energy feed blend for active and performance horses.',
      price: 45.99,
    },
    {
      name: 'Premium Oat Blend',
      role: 'Horse Food',
      image: '/HorseF2.jpeg',
      description: 'A balanced mix of oats and grains for optimal nutrition.',
      price: 39.99,
    },
    {
      name: 'Muscle Boost Pellets',
      role: 'Horse Food',
      image: '/HorseF3.jpeg',
      description: 'Protein-rich pellets to support muscle growth and strength.',
      price: 49.99,
    },
    {
      name: 'Digestive Care Formula',
      role: 'Horse Food',
      image: '/HorseF4.jpeg',
      description: 'Specially formulated feed for gut health and digestion.',
      price: 42.99,
    },
  ];

  return (
    <div className="bg-gradient-to-r from-orange-300 to-brown-500 py-24">
      <section className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-white mb-4 leading-tight tracking-tight">
            PREMIUM FOOD FOR YOUR HORSE 🐎
          </h1>
          <p className="text-lg text-white max-w-2xl mx-auto leading-relaxed">
            Give your horse the best nutrition for energy, strength, and overall health! 🌾🐴
          </p>
        </div>

        <div className="flex flex-wrap -m-4">
          {horseFoods.map((food, index) => (
